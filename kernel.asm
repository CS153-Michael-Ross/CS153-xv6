...
80103a7e:	c7 04 24 d0 72 10 80 	movl   $0x801072d0,(%esp)
80103a85:	e8 d6 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103a8a:	c7 04 24 fc 72 10 80 	movl   $0x801072fc,(%esp)
80103a91:	e8 ca c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103a96:	c7 04 24 ee 72 10 80 	movl   $0x801072ee,(%esp)
80103a9d:	e8 be c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103aa2:	c7 04 24 e2 72 10 80 	movl   $0x801072e2,(%esp)
...
80103bae:	e8 5d fe ff ff       	call   80103a10 <sched>
  panic("zombie exit");
80103bb3:	c7 04 24 1d 73 10 80 	movl   $0x8010731d,(%esp)
80103bba:	e8 a1 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103bbf:	c7 04 24 10 73 10 80 	movl   $0x80107310,(%esp)
...
80103c9e:	c7 04 24 2f 73 10 80 	movl   $0x8010732f,(%esp)
80103ca5:	e8 b6 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103caa:	c7 04 24 29 73 10 80 	movl   $0x80107329,(%esp)
...
80103d48:	e8 c3 2c 00 00       	call   80106a10 <freevm>
        release(&ptable.lock);
...
80103e48:	e8 c3 2b 00 00       	call   80106a10 <freevm>
        release(&ptable.lock);
...
80103fa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103fa8:	c7 04 24 bb 76 10 80 	movl   $0x801076bb,(%esp)
...
80103fca:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103fcd:	ba 40 73 10 80       	mov    $0x80107340,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103fd2:	77 11                	ja     80103fe5 <procdump+0x55>
80103fd4:	8b 14 85 a0 73 10 80 	mov    -0x7fef8c60(,%eax,4),%edx
      state = "???";
80103fdb:	b8 40 73 10 80       	mov    $0x80107340,%eax
...
80103ff0:	c7 04 24 44 73 10 80 	movl   $0x80107344,(%esp)
...
80104039:	c7 04 24 81 6d 10 80 	movl   $0x80106d81,(%esp)
...
80104354:	c3                   	ret    
    panic("acquire");
80104355:	c7 04 24 e1 73 10 80 	movl   $0x801073e1,(%esp)
...
801043a2:	e9 a9 fe ff ff       	jmp    80104250 <popcli>
    panic("release");
801043a7:	c7 04 24 e9 73 10 80 	movl   $0x801073e9,(%esp)
...
8010479d:	8b 14 85 20 74 10 80 	mov    -0x7fef8be0(,%eax,4),%edx
...
801047c6:	c7 04 24 f1 73 10 80 	movl   $0x801073f1,(%esp)
...
80104950:	c7 44 24 04 98 74 10 	movl   $0x80107498,0x4(%esp)
80104957:	80 
...
8010496b:	c7 44 24 04 97 74 10 	movl   $0x80107497,0x4(%esp)
80104972:	80 
...
80104981:	79 89                	jns    8010490c <create+0xdc>
      panic("create dots");
80104983:	c7 04 24 8b 74 10 80 	movl   $0x8010748b,(%esp)
8010498a:	e8 d1 b9 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010498f:	c7 04 24 9a 74 10 80 	movl   $0x8010749a,(%esp)
80104996:	e8 c5 b9 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010499b:	c7 04 24 7c 74 10 80 	movl   $0x8010747c,(%esp)
...
80104d41:	c7 44 24 04 98 74 10 	movl   $0x80107498,0x4(%esp)
80104d48:	80 
...
80104d59:	c7 44 24 04 97 74 10 	movl   $0x80107497,0x4(%esp)
80104d60:	80 
...
80104ead:	c7 04 24 bc 74 10 80 	movl   $0x801074bc,(%esp)
80104eb4:	e8 a7 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104eb9:	c7 04 24 ce 74 10 80 	movl   $0x801074ce,(%esp)
80104ec0:	e8 9b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104ec5:	c7 04 24 aa 74 10 80 	movl   $0x801074aa,(%esp)
...
8010534c:	e8 5f e7 ff ff       	call   80103ab0 <exit>
  return 0;  // not reached
}
80105351:	31 c0                	xor    %eax,%eax
80105353:	c9                   	leave  
80105354:	c3                   	ret    
80105355:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80105363:	5d                   	pop    %ebp
  return wait(status);
80105364:	e9 57 e9 ff ff       	jmp    80103cc0 <wait>
...
80105373:	5d                   	pop    %ebp
  return waitpid(pid, status, options);
80105374:	e9 37 ea ff ff       	jmp    80103db0 <waitpid>
...
80105394:	e8 17 f3 ff ff       	call   801046b0 <argint>
...
801053a3:	e8 68 eb ff ff       	call   80103f10 <kill>
}
801053a8:	c9                   	leave  
801053a9:	c3                   	ret    
...
801053e5:	e8 c6 f2 ff ff       	call   801046b0 <argint>
...
80105445:	e8 b6 ee ff ff       	call   80104300 <acquire>
  ticks0 = ticks;
...
8010546f:	e8 9c e7 ff ff       	call   80103c10 <sleep>
  while(ticks - ticks0 < n){
...
80105493:	e8 d8 ee ff ff       	call   80104370 <release>
      return -1;
...
801054af:	e8 bc ee ff ff       	call   80104370 <release>
}
...
801055a6:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
801055ac:	e8 df eb ff ff       	call   80104190 <initlock>
}
801055b1:	c9                   	leave  
801055b2:	c3                   	ret    
...
8010570b:	75 a8                	jne    801056b5 <trap+0xc5>
    exit(EXIT_FAILURE);
8010570d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105714:	e8 97 e3 ff ff       	call   80103ab0 <exit>
...
80105724:	75 a5                	jne    801056cb <trap+0xdb>
    yield();
80105726:	e8 a5 e4 ff ff       	call   80103bd0 <yield>
...
801057c1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801057c4:	e8 b7 ef ff ff       	call   80104780 <syscall>
    if(myproc()->killed)
...
801057d3:	0f 84 18 ff ff ff    	je     801056f1 <trap+0x101>
      exit(EXIT_FAILURE);
801057d9:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
...
801066d4:	0f 84 c3 00 00 00    	je     8010679d <switchuvm+0xed>
  pushcli();
801066da:	e8 31 db ff ff       	call   80104210 <pushcli>
...
8010678b:	5d                   	pop    %ebp
  popcli();
8010678c:	e9 bf da ff ff       	jmp    80104250 <popcli>
...
80106c44:	eb d8                	jmp    80106c1e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106c46:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
80106c4d:	e8 0e 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c52:	c7 04 24 d8 76 10 80 	movl   $0x801076d8,(%esp)
